...
function legal(type) {
  ...
  const legalBodyTranslations = {
    ...
    sv: {
      ...
      'Voimme käsitellä käyttäjän nimeä, sähköpostiosoitetta, kirjautumis- ja tilitietoja, yrityksen nimeä, yhteystietoja ja Y-tunnusta, tilaus- ja laskutustunnisteita, yrityksen tietopohjaan lisäämiä tietoja, palvelun asetuksia sekä asiakkaiden chat-, yhteydenotto-, tarjous-, SMS- ja ajanvaraustietoja siltä osin kuin yritys käyttää näitä toimintoja. Markkinointisivun kävijätilastointia varten käsitellään lisäksi vierailun ajankohtaa, avattua sivupolkua, viittaavaa verkkotunnusta, mahdollisia UTM-kampanjatietoja ja yksisuuntaisesti pseudonymisoitua kävijätunnistetta. Raakaa IP-osoitetta ei tallenneta kävijätilastotauluun.':'Vi kan behandla användarens namn, e-postadress, inloggnings- och kontouppgifter, företagsnamn, kontaktuppgifter och FO-nummer, abonnemangs- och faktureringsidentifierare, uppgifter som lagts till i företagets kunskapsbas, tjänsteinställningar samt kundernas chatt-, kontakt-, offert-, SMS- och bokningsuppgifter i den mån företaget använder dessa funktioner. För besöksstatistik på marknadsföringssidan behandlas även tidpunkten för besöket, sidvägen, hänvisande domän, eventuella UTM-kampanjuppgifter och en envägs pseudonymiserad besökaridentifierare. Den råa IP-adressen lagras inte i besöksstatistiktabellen.',
