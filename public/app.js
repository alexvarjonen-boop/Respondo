...
LEGAL['evasteet'] = {
  ...
  sections: [
    ...
    ['Kävijätilastointi ja markkinointievästeet', 'Respondon markkinointisivun oma kävijätilastointi toteutetaan palvelinpuolella eikä se aseta analytiikka- tai mainosevästeitä. Tilastointiin tallennetaan pseudonyymi kävijätunniste, sivupolku, viittaava verkkotunnus ja mahdolliset UTM-kampanjatiedot. Jos myöhemmin lisätään evästeisiin tai muuhun päätelaitetallennukseen perustuvaa ei-välttämätöntä analytiikkaa tai mainontaa, evästekäytäntö ja tarvittava suostumusratkaisu päivitetään ennen käyttöönottoa.'],
