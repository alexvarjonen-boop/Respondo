...
function socialAuthButtons(flow = 'signup') {
  ...
  return `<div class="social-auth">
    ...
    <a class="social-auth-btn apple-auth-btn" href="/api/auth/oauth/apple/start?flow=${flow}" aria-label="${label} Applella">
      <span class="social-auth-icon apple-icon" aria-hidden="true">
        <svg viewBox="0 0 24 24" width="22" height="22" role="img" aria-label="Apple">
          <path fill="currentColor" d="M16.7 12.7c0-2.5 2-3.7 2.1-3.8-1.2-1.8-3.1-2-3.8-2-1.6-.2-3.2 1-4 1-1 0-2.4-1-3.8-.9-1.9 0-3.6 1.1-4.6 2.8-2 3.4-.5 8.5 1.4 11.3.9 1.4 2 2.9 3.5 2.8 1.4-.1 2-1 3.7-1s2.2 1 3.8 1c1.6 0 2.5-1.4 3.4-2.8 1.1-1.6 1.5-3.2 1.5-3.3-.1 0-3.2-1.2-3.2-5.1Zm-2.8-7.5c.8-1 1.4-2.4 1.2-3.8-1.2.1-2.7.8-3.5 1.8-.8.9-1.4 2.3-1.2 3.7 1.3.1 2.7-.7 3.5-1.7Z"/>
        </svg>
      </span>
  ...
  return `<div class="appshell dashboard-simple-shell">
    <main class="appmain dashboard-simple-main">
      ...
      <section class="panel install-panel dashboard-view-section dashboard-view-hidden" data-dashboard-view="account" id="install">
        ...
        <div class="code-row"><code id="installCode">&lt;script src="${location.origin}/widget.js?v=20260919-omnichannel" data-company="${esc(t.slug)}"&gt;&lt;/script&gt;</code><button type="button" id="copyCode">Kopioi</button></div>
